...
const AllOrders = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const res = await axios.get(
        "https://bookscape-management-system-by-mern-2.onrender.com/api/v1/get-all-orders",
        { headers }
      );
  ...
  const submitChanges = async (i) => {
    ...
    const response = await axios.put(
      `https://bookscape-management-system-by-mern-2.onrender.com/api/v1/update-status/${id}`,
      Values,
      { headers }
    );
